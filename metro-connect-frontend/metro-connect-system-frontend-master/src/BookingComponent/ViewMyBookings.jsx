...
const ViewMyBookings = () => {
  ...
  const cancelMetroTicket = (bookingId) => {
    fetch(
              ...
              <tbody>
                {myBookings.map((booking) => {
                  return (
                    <tr>
                      <td>
                        <b>{booking.metroName}</b>
                      </td>
                      <td>
                        <b>{booking.metroNumber}</b>
                      </td>
                      <td>
                        ...
                        {(() => {
                          if (booking.status !== "Cancelled") {
                            return (
                              <button
                                onClick={() =>
                                  cancelMetroTicket(booking.bookId)
                                }
