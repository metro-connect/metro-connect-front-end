...
import "react-toastify/dist/ReactToastify.css";
import { useNavigate } from "react-router-dom";
import "./AdminRegisterForm.css"; // Importing custom CSS
...
const AdminRegisterForm = () => {
  ...
  return (
    <div className="d-flex vh-100 justify-content-center align-items-center bg-light">
      <div className="card form-card border-color shadow-lg" style={{ width: "25rem" }}>
        <div className="card-header bg-color text-center text-white">
          <h4 className="card-title">Admin Register</h4>
        </div>
        <div className="card-body">
